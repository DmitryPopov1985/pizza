...
import { addItem, removeItems, removeOneItem } from '../../../redux/slices/cartSlice'
...
const CartItem: React.FC<CartItemProps> = ({id, price, name, count, type, size, imageUrl, ...props}) => {
